...
import { SafeAreaView, View, TextInput, Image, StyleSheet, ScrollView, StatusBar, Animated } from "react-native";
            ...
            <SafeAreaView style={styles.header}>
                <View style={styles.upperHeader}>
                    <View style={styles.searchContainer}>
                        <Image source={require("./images/search.png")} style={[styles.icon16, { marginLeft: 8 }]} />
                        <AnimatedTextInput
                ...
                <View style={[styles.lowerHeader]}>
                    <Animated.View style={[styles.feature, depositViewAnimation]}>
                        <Animated.Image
                            source={require("./images/deposit.png")}
                            style={[styles.featureIcon, featureIconAnimation]}
                        />
                        <Animated.Image
                            source={require("./images/deposit-circle.png")}
                    ...
                    <Animated.View style={[styles.feature, withdrawViewAnimation]}>
                        ...
                        />
                        <Animated.Image
                            source={require("./images/withdraw-circle.png")}
                            style={[styles.icon32, featureIconCircleAnimation]}
                        />
                        <Animated.Text style={[styles.featureName, featureNameAnimation]}>Withdraw</Animated.Text>
                    </Animated.View>
                    ...
                    <Animated.View style={[styles.feature, qrViewAnimation]}>
                        ...
                        />
                        <Animated.Image
                            source={require("./images/qr-circle.png")}
                            style={[styles.icon32, featureIconCircleAnimation]}
                        />
                        <Animated.Text style={[styles.featureName, featureNameAnimation]}>QR</Animated.Text>
                    </Animated.View>
                    ...
                    <Animated.View style={[styles.feature, scanViewAnimation]}>
                        ...
                        />
                        <Animated.Image
                            source={require("./images/scan-circle.png")}
                            style={[styles.icon32, featureIconCircleAnimation]}
                        />
                        <Animated.Text style={[styles.featureName, featureNameAnimation]}>SCAN</Animated.Text>
                    </Animated.View>
                </View>
            </SafeAreaView>
